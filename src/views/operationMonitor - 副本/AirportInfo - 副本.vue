...
export default {
  ...
  computed: {
    counterUsedPercent: function () {
      ...
      if (this.resourceData.counter.freeNum == 0 && this.resourceData.counter.unavailNum == 0) {
        return '98%'
      } else {
        return  (this.resourceData.counter.usedNum / sumCount * 99) + '%'
      }
    },
    counterFreePercent: function () {
      let sumCount = this.resourceData.counter.usedNum + this.resourceData.counter.freeNum + this.resourceData.counter.unavailNum
      if (this.resourceData.counter.usedNum == 0 && this.resourceData.counter.unavailNum == 0) {
        return '98%'
      } else {
        return  (this.resourceData.counter.freeNum / sumCount * 99) + '%'
      }
    },
    counterUnavailPercent:function () {
      let sumCount = this.resourceData.counter.usedNum + this.resourceData.counter.freeNum + this.resourceData.counter.unavailNum
      if (this.resourceData.counter.usedNum == 0 && this.resourceData.counter.freeNum == 0) {
        return '98%'
      } else {
    ...
    chuteUsedPercent: function () {
      ...
      if (this.resourceData.chute.freeNum == 0 && this.resourceData.chute.unavailNum == 0) {
        return '98%'
      } else {
    ...
    chuteFreePercent: function () {
      let sumCount = this.resourceData.chute.usedNum + this.resourceData.chute.freeNum + this.resourceData.chute.unavailNum
      if (this.resourceData.chute.usedNum == 0 && this.resourceData.chute.unavailNum == 0) {
        return '98%'
      } else {
    ...
    chuteUnavailPercent:function () {
      let sumCount = this.resourceData.chute.usedNum + this.resourceData.chute.freeNum + this.resourceData.chute.unavailNum
      if (this.resourceData.chute.usedNum == 0 && this.resourceData.chute.freeNum == 0) {
        return '98%'
      } else {
    ...
    beltUsedPercent: function () {
      ...
      if (this.resourceData.belt.freeNum == 0 && this.resourceData.belt.unavailNum == 0) {
        return '98%'
      } else {
    ...
    beltFreePercent: function () {
      let sumCount = this.resourceData.belt.usedNum + this.resourceData.belt.freeNum + this.resourceData.belt.unavailNum
      if (this.resourceData.belt.usedNum == 0 && this.resourceData.belt.unavailNum == 0) {
        return '98%'
      } else {
    ...
    beltUnavailPercent:function () {
      let sumCount = this.resourceData.belt.usedNum + this.resourceData.belt.freeNum + this.resourceData.belt.unavailNum
      if (this.resourceData.belt.usedNum == 0 && this.resourceData.belt.freeNum == 0) {
        return '98%'
      } else {
