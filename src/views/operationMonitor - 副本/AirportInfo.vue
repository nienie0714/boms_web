    ...
    <div class="airport-info">
        ...
        <div class="airport-image-box">
            ...
            <div class="airport-name">
                {{_getAirportTypeText(airportType)}}
            </div>
            ...
            <div class="info-middle-base info-right">
                ...
                <div class="step-info">
                    ...
                    <div class="step-info-number-middle">
                        ...
                        <span class="step-info-number-max">4018</span>
                    </div>
                    <div class="step-info-bottom">
                        未装机 / 应装机
                    </div>
        ...
        <div class="device-info">
            ...
            <div class="device-row">
                <div class="device-icon-box">
                    <div class="device-icon plane-place"></div>
                    <div class="device-name">机位</div>
                </div>
...
<style lang="scss" scoped>
    ...
    .number.warning {
        ...
        -webkit-text-stroke: 1px #FF5F79 !important;
        text-stroke: 1px #FF5F79 !important;
    }
