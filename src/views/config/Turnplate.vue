...
import Detail from './detail/TurnplateDetail'
...
export default {
    ...
    methods:{
        ...
        customQueryBefore () {
          this.$set(this.queryData, 'resourceType','BELT')
        },
        ...
        handleSubmit ({data, type, other}) {
            ...
            if(type=='insert'){
                this.$set(data,'resourceType','BELT')
            }
            if (data) {
                switch (type) {
