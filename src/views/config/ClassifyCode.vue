...
import Detail from './detail/ClassifyCodeDetail'
...
export default {
    ...
    data() {
        return {
            queryUrl: '/base/classifyCode/pageQuery', // /',pageQuery
            exportUrl: '/base/classifyCode/exportExcel',
            updateUrl:'/base/classifyCode',
            insertUrl:'/base/classifyCode',
            removeUrl:'/base/classifyCode',
            title:'分类信息',
            ...
            tableData:{
                    ...
                    column:[
                        ...
                        [
                            ...
                            {key:'code',label:'代码',width:220},
                            {key:'classify',label:'类别',width:220},
                            {key:'name',label:'名称',width:220},
                            {key:'remark',label:'备注',width:500}
                        ],
                        //center
                        [
