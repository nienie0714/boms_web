    ...
    data() {
        return {
            ...
            form:{
                ...
                detailColumn:[
                    [
                        {key:'resourceNo',label:'滑槽编号',span:'12'},
                        {key:'attrCn',label:'属性',span:'12'},
                    ],
                    [
                        {key:'agencyCn',label:'代理',span:'8'},
                ...
                column:[
                            {key:'resourceNo',label:'滑槽编号',type:'input',maxlength:20},
                ...
                rules:{
                    resourceNo:[
                        ...
                        {type: 'unique', url: '/base/terminalResource', trigger: 'blur',resourceType:'CHUTE'},
                        {type: 'unique', url: '/base/terminalResource', trigger: 'chnage',resourceType:'CHUTE'},
            ...
            handler(visible){
                ...
                if(visible&&this.type=='update'){
                    this.form.column.forEach((item,index) => {
                        ...
                        if(item.key!='terminalNo'&&item.key!='resourceNo'){
                              this.$set(item, 'disabled', false)
                        }
                    })
                }
