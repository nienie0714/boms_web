    ...
    data(){
        return{
                ...
                form:{
                    ...
                    detailColumn:[
                        [
                            {key:'resourceNo',label:'值机柜台编号',span:'12'},
                            {key:'attrCn',label:'属性',span:'12', formatter: true},
                            
                        ],
                        [
                            {key:'terminalNo',label:'所属航站楼',span:'12'},
                            {key:'isUseableCn',label:'状态',span:'12', formatter: true},
                        ],
                        [
                            {key:'reserved1',label:'所属值机岛',span:'8'},
                            {key:'agencyCn',label:'地面代理',span:'8'},
                            {key:'reserved3',label:'对应PID号',span:'8'}
                        ],
                        [
                    ...
                    column:[
                            {key:'resourceNo',label:'值机柜台编号',type:'input',maxlength:20},
                            {key:'attr',label:'属性',type:'select',enumKey: 'arrtN', itemValue: 'code', itemLabel: 'name'},
                            ...
                            {key:'reserved1',label:'所属值机岛',type:'input'},
                            {key:'reserved3',label:'对应PID号',type:'input'},
                            {key:'remark',label:'备注',type: 'textarea', rows: 2, maxlength: 100}
                    ],
                    rules:{
                        resourceNo:[
                            {type: 'require', trigger: 'blur'}, 
                            {type: 'unique', url: '/base/terminalResource', trigger: 'blur',resourceType:'COUNTER'},
                            {type: 'unique', url: '/base/terminalResource', trigger: 'change',resourceType:'COUNTER'},
                        ...
                        reserved3:[
                            {type: 'regex', reg: /^[0-9]+$/, info: '必须由数字组成'},
                        ],
                        isUseable:[
                             {type: 'require', trigger: 'blur'}, 
                        ]
