<template>
  <div class="input-tag" :style="`width: ${width}px`">
    ...
    <div class="value">
      ...
      <el-select v-else-if="type == 'select'" v-model="currentValue" :disabled="disabled" :multiple="multiple" :collapse-tags="multipleShow" :filterable="filterable" :clearable="clearable">
      ...
      <el-date-picker v-if="type == 'elDate'" :type="datetype" :picker-options="pickerOptions" v-model="currentValue" placeholder="选择日期" :format="format" :value-format="valueFormat" :clearable="clearable"></el-date-picker>
      <el-date-picker v-if="type == 'elDateTimeRange'" v-model="currentValue" type="datetimerange" range-separator="-" start-placeholder="开始日期" end-placeholder="结束日期" :format="format" :value-format="valueFormat">
      </el-date-picker>
      <el-date-picker v-if="type == 'elDateRange'" v-model="currentValue" type="daterange" range-separator="-" start-placeholder="开始日期" end-placeholder="结束日期" :format="format" :value-format="valueFormat">
      </el-date-picker>
